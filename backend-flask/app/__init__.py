...
def create_app():
    ...
    def swagger_ui():
        return render_template(
            ...
            swagger_ui_standalone_preset_js='https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/4.15.5/swagger-ui-standalone-preset.min.js',
            base_url=API_URL
        )
    ...
    "version": "1.0.0"
        ...
        return render_template('endpoint_docs.html', endpoint_data=endpoint_data[api_endpoint])
